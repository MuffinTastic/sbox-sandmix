    ...
    public class TransferFunction
    {
        ...
        public StateSpace StateSpace
        {
            get
            {
                ...
                if (K == 1)
                {
                    ...
                    {
                        A = new NWaves.Utils.Matrix(1).As2dArray(),
                        B = new double[M],
                        C = new double[M],
                ...
                var a = new NWaves.Utils.Matrix( K - 1);
                for (var i = 0; i < K - 1; i++)
                {
        ...
        public double[] Zi
        {
            get
            {
				...
				NWaves.Utils.Matrix m = NWaves.Utils.Matrix.Eye(size - 1) - NWaves.Utils.Matrix.Companion(a).T;
